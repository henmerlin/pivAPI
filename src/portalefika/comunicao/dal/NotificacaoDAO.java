...
public class NotificacaoDAO extends ComponentePortalDAO {
    ...
    public List<Notificacao> listarEsp() {
        try {
            Query query = this.entityManager.createQuery("FROM Notificacao n WHERE n.ativo =:param1 AND CURDATE() BETWEEN n.dataInicio AND n.dataFim");
